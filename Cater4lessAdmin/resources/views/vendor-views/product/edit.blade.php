            ...
            <div class="form-group mb-0 h-100 d-flex flex-column align-items-center justify-content-center">
                <label>
                    <center id="pdf-viewer-section" class="my-auto">
                        ...
                        @if ($product?->pdf_full_url)
    <i class="tio-file-outlined" style="font-size: 40px;"></i>
    <p class="mt-2 text-success">{{ translate('PDF already uploaded') }}</p>
    <a href="{{ $product->pdf_full_url }}" target="_blank" class="btn btn-sm btn-primary mt-2">
        {{ translate('View PDF') }}
    </a>
@else
    <i class="tio-file-outlined" style="font-size: 40px;"></i>
...
@endif
                        ...
                        <input type="file" name="pdf_file" id="customFilePdf"
