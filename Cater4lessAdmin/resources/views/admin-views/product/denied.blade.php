        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-auto mb-md-0 mb-3 mr-auto">
                    <h1 class="page-header-title"> {{ translate('messages.rejected_food_request') }}<span
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link "  aria-disabled="true" href="{{route('admin.food.pending')}}">{{translate('messages.Pending_Requests')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.food.denied')}}"  >{{translate('messages.Rejected_Request')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="media align-items-center"
                                                ...
                                                <img class="avatar avatar-lg mr-3 onerror-image"
                                                    src="{{ $food['image_full_url'] }}" alt="{{ $food->name }} image">
                                        ...
                                        <td>
                                            @if ($food->restaurant)
                                                <a class="text--title"
                                                    ...
                                                    title="{{ translate('view_restaurant') }}">
                                                    {{ Str::limit($food->restaurant->name, 20, '...') }}
                                                </a>
                                            @else
                                                <span
                                                    class="text--danger text-capitalize">{{ Str::limit(translate('messages.Restaurant_deleted!'), 20, '...') }}<span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                @endif
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                    href="" title="{{ translate('messages.approve_food') }}"><i
                                                        class="tio"></i>
                                                </a>
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                    ...
                                                    <div class="table-rest-info mb-30 align-items-start">
                                                        ...
                                                        <div class="info fs-12 text-body">
                                                            <span class="d-block text-title fs-15 mb-2">
                                                                ...
                                                                @if ($food->veg == 1)
                                                                    <span
                                                                        class="badge badge-soft-success rounded-pill">{{ translate('Veg') }}</span>
                                                                @else
                                                                    <span
                                                                        class="badge badge-soft-danger rounded-pill">{{ translate('Non_Veg') }}</span>
                                                                @endif
                                                            </span>
                                                            <div>
                                                                {{ translate('Price') }} : <span
                                                                    class="font-medium">{{ \App\CentralLogics\Helpers::format_currency($food['price']) }}</span>
                                                                | {{ translate('Discount') }} : <span class="font-medium">
                                                    ...
                                                    <form action="{{ route('admin.food.updateStock') }}" method="POST">
                                                        ...
                                                        <div class="__bg-F8F9FC-card text-left">
                                                            ...
                                                            <input type="number" step="1" name="item_stock"
                                                                ...
                                                                max="99999999999" class="form-control"
                                                                placeholder="Ex : 50">
                                                        </div>
